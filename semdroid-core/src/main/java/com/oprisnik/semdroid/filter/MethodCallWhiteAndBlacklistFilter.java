...
/**
 * White- and Blacklist filter for method calls.
 */
public class MethodCallWhiteAndBlacklistFilter implements MethodCallFilter {
    ...
    @Override
    public boolean use(MethodCall data) {
