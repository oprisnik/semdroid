...
/**
 * Opcode grouper for crypto code.
 * This is an example on how an opcode grouper can be defined in code.
 */
public class CryptoOpcodeGrouper extends FieldBasedOpcodeGrouper {
    ...
    public static final int OP_ARRAY_LENGTH = DexOpcodes.OP_ARRAY_LENGTH;
