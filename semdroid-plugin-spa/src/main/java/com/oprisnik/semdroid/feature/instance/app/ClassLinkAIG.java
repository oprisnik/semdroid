...
/**
 * App instance generator that creates links to all classes of the application.
 */
public class ClassLinkAIG extends AppInstanceGenerator {

    @Override
    protected void getAppInstance(App app, InstanceDataElement results) {
        for (DexClass c : app.getClasses()) {
            results.addValue(getInstanceReferenceDataElement(c));
        }
    }
