...
/**
 * Method instance generator for crypto code
 */
public class CryptoMIG extends MethodInstanceGenerator {
    ...
    protected void getMethodInstance(DexMethod method,
        ...
        results.addValue(getDistanceBasedFeatureDataElement("opcodes",
                getOpcodeHistogram(method, true)));
        results.addValue(getDistanceBasedFeatureDataElement("localVars", getBasicLocalVarHistogram(method, true)));
    }
