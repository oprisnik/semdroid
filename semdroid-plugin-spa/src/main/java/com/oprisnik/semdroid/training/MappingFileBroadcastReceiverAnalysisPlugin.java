 ...
 */
public class MappingFileBroadcastReceiverAnalysisPlugin extends MappingFileAnalysisPlugin {

    public final static String NORMAL_LABEL = "NORMAL_RECEIVER";

    private static final String TAG = "MappingFileBroadcastReceiverAnalysisPlugin";
