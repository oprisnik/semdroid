...
/**
 * SMS classifier to label SMS sniffers - onReceive-methods only.
 */
public class SMSSnifferOnReceiveAnalysisPlugin extends BaseAnalysisPlugin {

    private static final String TAG = "SMSSnifferOnReceiveClassifier";
                ...
                if (f.getAction() != null
                    ...
                    if (clazz != null) {
                        ...
                        for (DexMethod m : clazz.getMethods()) {
                            if (m.getMethodName().equals("onReceive"))
